      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            @if(Auth::user()->guest())            
            <li class="{{$current['login']}}" data-toggle="modal" data-target="#myModal" ><a href="#">Iniciar Sesion</a></li> 
       ...
       @if(Auth::user()->get())
          <ul class="nav navbar-right top-nav">
            <a class="navbar-brand" >Bienvenido,{{Auth::user()->get()->user}}</a>
          <a href="{{URL::route('privado')}}">
                {{Form::label("Opciones", null, array('class' => 'btn btn-danger'))}}
          </a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">        
             ...
             <div class="form-group has-feedback has-success">          
             <label class="control-label col-md-4" for="remember"><a href="{{URL::route('recoverpassword')}}">Forgot?</a></label>
             </div>           
